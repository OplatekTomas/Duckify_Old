...
namespace SpotifyUWP {
    ...
    public sealed partial class SpotifyLogin : Page {
        ...
        private void Browser_Loaded(object sender, RoutedEventArgs e) {
            ...
            listener.Start();
            Browser.Navigate(new Uri("http://accounts.spotify.com/authorize?client_id=146234f4fccf47ffbe4de27b8b472ce8&response_type=code&redirect_uri=http://127.0.0.1:8000&scope=streaming%20user-read-birthdate%20user-read-email%20user-read-private"));
        }
        ...
        private async Task<Spotify.TokenInfo> GetToken(string accessCode) {
            using(HttpClient client = new HttpClient()) {
                HttpRequestMessage message = new HttpRequestMessage(HttpMethod.Post, "https://accounts.spotify.com/api/token");
                //Build url encoded body
                var content = new StringContent("grant_type=authorization_code&code=" + accessCode + "&redirect_uri=http://127.0.0.1:8000");
                ...
                if (response.IsSuccessStatusCode) {
                    ...
                    return JObject.Parse(res).ToObject<Spotify.TokenInfo>();
                } else {
                    return null;
                }
            }
